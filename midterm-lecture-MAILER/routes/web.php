...
Route::get('forgotPassword', [ForgotPassController::class, 'showForgotPasswordForm'])->name('forgot.password.form');
Route::post('forgotPassword', [ForgotPassController::class, 'handleForgotPassword'])->name('password.email');
